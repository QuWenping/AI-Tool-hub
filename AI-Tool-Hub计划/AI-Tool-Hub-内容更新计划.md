...
- **必做（新 solutions.json 记录 + 新页面自动生成）**：
  - [x] `ai-for-mechanical-engineers` @Claude 2026-07-21
  - [x] `ai-for-electrical-engineers` @Claude 2026-07-21
  - [x] `ai-for-mep-engineers` @Claude 2026-07-21
  - [x] `ai-for-bridge-engineers` @Claude 2026-07-21
  - [x] `ai-for-steel-detailers` @Claude 2026-07-21
  - [x] `ai-for-surveyors` @Claude 2026-07-21
  - [x] `ai-for-quantity-surveyors` @Claude 2026-07-21
  - [x] `ai-for-fire-protection-engineers` @Claude 2026-07-21
  - [x] `ai-for-plumbing-engineers` @Claude 2026-07-21
  - [x] `ai-for-project-engineers` @Claude 2026-07-21
...
- **现状**：Impr 10 / Pos 42.5 — 页面太弱（✅ 已完成：reviewed=true，8.4/10，10 FAQ @Claude 2026-07-21）
- **必做**：
  - [x] Assembly AI 添加到 `tool-editorial.json`（reviewed=true，10 FAQ）@Claude 2026-07-21
  - [x] `assemblyai` tool ID 存在性检查 → tools.json 键为 `assembly-ai` ✅
  - [x] 若 slug 是 `assembly-ai` 或其它，先对齐 ID → 加入编辑元数据 ✅
- **文件归属**：Claude 独占 `src/data/tool-editorial.json`
### U-05 建筑 / 工程行业深度化（AI Rendering / Floor Plan / BIM / CAD / Revit / SketchUp / Rhino）

- **现状**：ai-for-architects Pos 50 — 需要 Cluster 页
- **本批已交付（6 篇行业指南博客，2026-07-21）**：
  - [x] `blog/ai-tools-for-civil-engineers-2026` @Claude 2026-07-21
  - [x] `blog/ai-tools-for-structural-engineers-2026` @Claude 2026-07-21
  - [x] `blog/ai-tools-for-mechanical-engineers-2026` @Claude 2026-07-21
  - [x] `blog/ai-tools-for-electrical-engineers-2026` @Claude 2026-07-21
  - [x] `blog/ai-tools-for-construction-managers-2026` @Claude 2026-07-21
  - [x] `blog/ai-tools-for-bim-engineers-2026` @Claude 2026-07-21
- **剩余**：architecture / rendering / floor-plan / Revit / SketchUp / Rhino 等细分 Cluster 页 + 与 ai-for-architects 的 hub-and-spoke 链接
...
- **R1-05** Assembly AI review（GSC Impr 10，Pos 42.5）✅ 已完成（U-04）
- **R1-06** Agnes AI 编辑元数据补齐（如 `agnes-ai` tool ID 存在则加编辑数据支持 U-01）
- R1-07~R1-20：原清单降级为 P1（一天不做也无风险）
- **R1-21~R1-30**：新增 Engineering 行业方案（U-02）10 页 ✅ 已完成

**现状（2026-07-21）**：
- Reviewed：17 → 22（+5：deepseek / windsurf / cline / codeium / assembly-ai）
- Solution pages：18 → 28（+10：mechanical / electrical / MEP / bridge / steel / surveyor / QS / fire / plumbing / project）
...
- [x] R1-02 `windsurf` review @Claude 2026-07-21
- [x] R1-03 `cline` review @Claude 2026-07-21
- [x] R1-04 `codeium` review @Claude 2026-07-21
- [x] R1-05 `bolt` review @Claude 2026-07-21
- [x] R1-06 `v0` review @Claude 2026-07-21
- [x] R1-07 `lovable` review @Claude 2026-07-21
- [x] R1-08 `replit` review @Claude 2026-07-21
- [x] R1-09 `aider` review @Claude 2026-07-21
- [x] R1-10 `flux` review @Claude 2026-07-21
- [x] R1-11 `ideogram` review @Claude 2026-07-21
- [x] R1-12 `krea` review @Claude 2026-07-21
- [x] R1-13 `canva-ai` review @Claude 2026-07-21
- [x] R1-14 `pika` review @Claude 2026-07-21
- [x] R1-15 `luma` review @Claude 2026-07-21
- [x] R1-16 `kling` review @Claude 2026-07-21
- [x] R1-17 `hailuo` review @Claude 2026-07-21
- [x] R1-18 `fireflies` review @Claude 2026-07-21
- [x] R1-19 `otter` review @Claude 2026-07-21
- [x] R1-20 `gamma` review @Claude 2026-07-21

**R1 阶段总结**：20/20 全部 reviewed，reviewed 工具总数 17 → 39。每条含 8 字段 + 10 FAQ + sourceUrl + scoreBreakdown；npx build 2529 页通过，0 错误。详见工具编辑元数据文件 `src/data/tool-editorial.json`。

### Week 3-4：Comparison 长文

- [x] V-01 Cursor vs Windsurf @Claude 2026-07-21
- [x] V-02 Cursor vs Claude Code @Claude 2026-07-21
- [x] V-03 Cursor vs GitHub Copilot（升级已有）@Claude 2026-07-21
- [x] V-04 ChatGPT vs Claude（升级已有）@Claude 2026-07-21
- [x] V-05 Claude vs Gemini（升级已有）@Claude 2026-07-21
- [x] V-06 Midjourney vs DALL-E 3 @Claude 2026-07-21
- [x] V-07 Midjourney vs Flux @Claude 2026-07-21
- [x] V-08 Bolt vs Lovable @Claude 2026-07-21
...
**V 阶段 1 总结（V-01 → V-08 已交付）**：8/20 篇 P0 对比长文，命名 `{slug}-2026.astro`，从项目数据（tools.json + tool-editorial.json + 官方文档）从零生成。结构 Hero + TLDR + 8 H2（What it is / Agent / Models / Pricing / Pros-Cons / Best for / Verdict / FAQ）+ 5 FAQ + SVG 对比流程图。每篇 5+ 内链 / 3 官方来源 / 0 inline style。脚本 `scripts/gen-v-posts.py` 留档可重跑。`npm run build` 通过，2536 页。

**V 阶段 2 剩余（V-09 → V-20，12 篇）**：下周计划，涵盖 AI Video（V-09~V-11）、AI Chat/Productivity（V-12~V-13）、AI Audio/Meeting（V-14~V-15）、更多 AI Coding（V-16~V-18）、Image/Code 收尾（V-19~V-20）。
...
### Week 2 · 2026-07-21（已交付）

**Claude 产出（数据 + 内容）**
- ✅ V-01 → V-08 共 8 篇 P0 对比长文交付到 `src/pages/blog/`：
  - V-01 `cursor-vs-windsurf-2026` · V-02 `cursor-vs-claude-code-2026` · V-03 `cursor-vs-github-copilot-2026` · V-04 `chatgpt-vs-claude-2026` · V-05 `claude-vs-gemini-2026` · V-06 `midjourney-vs-dalle3-2026` · V-07 `midjourney-vs-flux-2026` · V-08 `bolt-vs-lovable-2026`
  - 每篇统一骨架：TLDR 4 条 + 8 H2（What it is / Agent / Models / Pricing / Pros-Cons / Best for / Verdict / FAQ）+ 5 FAQ + SVG 对比流程图 + 3 官方来源
  - 5+ 内链 / 0 inline style / BlogPostLayout / title 49-61 / description 132-158（全部合格）
  - 完全基于项目数据（`tools.json` + `tool-editorial.json` + 官方文档）从零生成；不编造测试/benchmark
  - 生成脚本 `scripts/gen-v-posts.py` 留档（f-string 解析坑已注释：避免 `{[{X}]}` 这种内层是 list 字面的字段替换）
  - `npm run build` 通过，2536 页（+7 from Week 1）

**累计基线（2026-07-21 收尾）**
- Reviews：39 / 200 ✅
- Comparisons 长文：~4 + 8 = 12 / 60（升级已有 4 个的兄弟链接已在文内推荐）
- Blog：50 / 100（6 行业 + 8 对比 = 14 本周新增；旧 blog 44 + 14 = 50；旧 44 是目录数，新 14 均为深度版）
- Topic Clusters：0 / 8
- Internal links audit：未运行
- Backlinks：0 / 30
- 下周计划：V-09 → V-20（12 篇对比长文，按 Plan 阶段 2 剩余清单）

### Week 1 · 2026-07-21（已交付）

**Claude 产出（数据层）**
- ✅ R1-01 → R1-20 全部 20 篇 Review 元数据入 `tool-editorial.json`（17 → 39 条 reviewed）
  - 包含 R1-01~R1-08（deepseek/windsurf/cline/codeium/bolt/v0/lovable/replit，本次同步勾选状态）+ R1-09~R1-20（aider/flux/ideogram/krea/canva-ai/pika/luma/kling/hailuo/fireflies/otter/gamma，本批新增）
  - 每条均含 `reviewed + updatedAt + testedVersion + score + quickFacts + pricingSummary[en/zh] + 10 FAQ[en/zh] + sourceUrl + scoreBreakdown`
  - 脚本 `scripts/gen-r1-editorial.py` 留档可重跑
- ✅ U-02 10 个新 Solutions 已在 `solutions.json`（mechanical / electrical / MEP / bridge / steel / surveyor / QS / fire / plumbing / project），已勾选
- ✅ U-04 Assembly AI editorial 元数据已就位（已勾选）
- ✅ 本批 6 篇行业指南博客（BIM / Civil / Structural / Mechanical / Electrical / Construction）已生成并发布到 `src/pages/blog/`
  - 命名与 plan U-05 命名一致（`ai-tools-for-{行业}-2026.astro`）
  - 完全基于项目内 `solutions.json` + `tool-editorial.json` + 公开代码机构（ASCE / ASHRAE / NEC / OSHA / ISO 19650 / EPA 等）从零生成，**不基于 content-brief 草稿**
  - 每篇 5+ FAQ / 7-8 H2 / 11-17 内链 / 3 官方来源（rel="nofollow noopener"）/ 1 SVG 流程图 / 0 inline style / BlogPostLayout
  - `npm run build` 通过，2529 页，0 错误

**决策记录**
- ⚠️ `content-brief/pages/blog/` 30 篇草稿（含 5 篇 `_temp_disabled`）经审查后**全部弃用**：含未验证测试声明、无内链、无来源、无图片、9 篇被替换为未批准题目。决策：基于 `VALIDATION_REPORT.md` 不重用，作为草稿存档；新内容全部从项目数据重写。
- ⚠️ U-03 Bonsai 27B 6 篇博客暂缓启动（plan 标识 [ ]，未勾选）：6 篇主题缺乏可验证官方来源（Prism ML / Bonsai 27B 不可公开核验），按 `REVISION_INSTRUCTIONS.md` 红线不编造 benchmark/测试。已发布的 `bonsai-27b-on-device-ai-phone-2026`（GSC Impr 22 / Pos 7.4）保留不动；`src/pages/blog/_temp_disabled/` 2 篇内容已写好但因同样原因保持禁用。
- ⚠️ U-01 agnes-ai CTR 优化文件 `src/pages/blog/agnes-ai-review-free-omni-modal-api-2026.astro` 属 33 篇 legacy 之一，本周内仍未动；editorial 元数据侧已加 `agnes-ai` 条目（reviewed=true，10 FAQ），仅剩 legacy 文件 title/meta/FAQ/JSON-LD 重写待 Codex 协助。

**Codex 上游 changelog**（同 Week 1）
- 见上方沿用记录：BlogPostLayout 上线、32 篇 legacy 迁 BlogPostLayout、46 篇博客页面级 inline style 清零、动态模板 prompts/templates/workflows [slug] 683 页 + 11 个交互式 tools/*.astro + 组件级 inline style（Feedback/Chart）剩余 @Codex
- ⚠️ Codex 仍需处理：`solutions.json` 新条目 `ai-for-mechanical-engineers` 缺 `tools` 与 `sections` 字段（沿用历史问题）

**基线累计（2026-07-21 收尾）**
- Reviews：39 / 200 ✅ R1 阶段完成
- Comparisons 长文：~4 / 60
- Blog：44 + 6 = 50 / 100
- Topic Clusters：0 / 8
- Internal links audit：未运行
- Backlinks：0 / 30
- 备注：R1 主批量 100% 完成；下周计划：Week 2 R2 = 启动 Comparison 长文（V-01 → V-20，按 Plan 阶段 2）
